...
namespace Xamarin.Android.Prepare
{
	static partial class Utilities
	{
		...
		public static async Task<bool> ConjureXamarinAndroidCecil (Context context, bool haveManagedRuntime, string managedRuntime)
		{
			var msbuild = new MSBuildRunner (context);
			...
			//StatusStep (context, "Conjuring Xamarin.Android.Cecil and Xamarin.Android.Cecil.Mdb");
