...
{
	public class GenerateAndroidManifest : DirectoryAssemblyResolverTask
	{
		...
		public override bool RunTask ()
		{
			...
			manifest.PackageName =
				manifest.ApplicationName = PackageName;
			...
			foreach (var type in all_java_types) {
				if (JavaTypeScanner.ShouldSkipJavaCallableWrapperGeneration (type)) {
					continue;
				}
